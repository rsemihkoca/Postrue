  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.buttonsContainer}>
          <PressableInput
            ...
            style={[
              ...
              {
                backgroundColor:
                  activeChart === "Monthly" ? colors.Monthly : "#e3e3e3",
              },
            ]}
          >
            <Text
              style={[
                styles.buttonText,
                { color: activeChart === "Monthly" ? "#e3e3e3" : "#000" },
              ]}
            >
              Monthly
            </Text>
          ...
          <PressableInput
            ...
            style={[
              ...
              {
                backgroundColor:
                  activeChart === "Weekly" ? colors.Weekly : "#e3e3e3",
              },
            ]}
          >
            <Text
              style={[
                styles.buttonText,
                { color: activeChart === "Weekly" ? "#e3e3e3" : "#000" },
              ]}
            >
              Weekly
            </Text>
          ...
          <PressableInput
            ...
            style={[
              ...
              {
                backgroundColor:
                  activeChart === "Daily" ? colors.Daily : "#e3e3e3",
              },
            ]}
          >
            <Text
              style={[
                styles.buttonText,
                { color: activeChart === "Daily" ? "#e3e3e3" : "#000" },
              ]}
            >
              Daily
            </Text>
      ...
      <View style={styles.chart}>
        ...
        <Text style={styles.name}>Posture Score</Text>
        <Chart color={colors[activeChart]} />
        <View style={{ marginTop: getHeight(40) }}>
          <Text
            style={[
              styles.chartDetailsTitle,
              { color: colors[activeChart], fontSize: 24 },
            ]}
          >
            Average Scores
          </Text>
          <View style={styles.chartDetails}>
            <View>
              ...
              <Text style={styles.chartDetailsValue}>20</Text>
            </View>
            <View>
